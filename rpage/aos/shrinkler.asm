...
;-------------------------------------------------------------------------------
;adaptation the to SAS/C Amiga Assembler syntax by RESISTANCE.NO, 2019
;(see https://github.com/ResistanceVault/rpage)
;original source code of the Srinkler depacker by Aske Simon Christensen
;(see https://github.com/askeksa/Shrinkler) 
;-------------------------------------------------------------------------------
		SECTION	Code
		XDEF _ShrinklerDecompress
